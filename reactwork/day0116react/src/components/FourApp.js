...
function FourApp(props) {
    ...
    return (
        <div>
            <h3 className='alert alert-success'>FourApp-부모,자식간 통신(props)</h3>
            <h4><b>방문횟수 : {count}회</b></h4>
            <FourChildApp name={"캔디"} age={"23세"} addr={"제주도"} incre={changeCount}/>
            <FourChildApp name={"캔디"} age={"23세"} addr={"LA"} incre={changeCount}/>
            <FourChildApp name={"캔디"} age={"23세"} addr={"하와이"} incre={changeCount}/>
        </div>
    );
}
