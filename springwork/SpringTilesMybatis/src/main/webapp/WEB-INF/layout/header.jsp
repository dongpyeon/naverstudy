...
$(function(){
	...
	$("#btnlogin").click(function(){
		let saveid=$("#saveid").is(":checked"); //true/false,val() 은 체크여부와 상관없이 무조건 'on' 이라서 checked로 확인
        	...
        	<caption>
        		<label>
        			...
        			<c:if test="${sessionScope.saveid=='yes' }">
        				<input type="checkbox" id="saveid" checked="checked">&nbsp;아이디저장
        			</c:if>
        		</label>
        	</caption>
        	<tr>
...
<a href="${root }/" style="font-size: 30px;">
 <img alt="" src="${root }/res/photo/sim.gif" width="50" hspace="20">
Spring5
<img alt="" src="${root }/res/photo/sim.gif" width="50" hspace="20">
</a>
...
<script type="text/javascript">
	...
	$("#profile_upload").change(function(){
		...
		$.ajax({
			...
			processData:false, // 이 두개는 파일 업로드 할때만 ajax에 넣는것.
			contentType:false, //
			data:form,
			success:function(res){
