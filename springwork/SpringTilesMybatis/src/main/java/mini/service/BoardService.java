...
public class BoardService {
	...
	{
		int num=dto.getNum(); //새글일 경우 0, 답글일 경우 0보다 큰 값이 들어있다.
		...
		if(num==0) {
			...
			//답글인 경우 그룹은 그대로 사용하므로 regroup은 따로 안 구한다.
			//답글인 경우.
			this.updateRestep(regroup, restep);//같은 그룹 중 전달받은 restep보다 큰 값이 있는 글들을 모두 +1을 해준다
