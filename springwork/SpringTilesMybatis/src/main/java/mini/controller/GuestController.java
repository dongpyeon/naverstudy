...
public class GuestController {
	...
	private String bucketName="guest-kdh";
	...
	@ResponseBody public String getVoice(String message,String lang,HttpServletRequest request)
	{
		...
		String clientId = "4165srbbuj";//애플리케이션 클라이언트 아이디값";
		String clientSecret = "Am6XkBXLdRYWZwHlCcxAngt02j0XINdGOm3KUTuL";//애플리케이션 클라이언트 시크릿값";
		try {
