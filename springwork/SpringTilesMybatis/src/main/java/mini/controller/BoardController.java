...
public class BoardController {
	...
	public String list(Model model, @RequestParam(defaultValue ="1") int currentPage)
	{
		...
		//각페이지당 불러올 글의 번호
		//10개씩일 경우 기준
		//1페이지:0~9 2페이지:10~19 3페이지:31-40
	...
	public String form(
		Model model,
		/*새글일 경우 값이 안넘어오므로 defaltValue 값이 입력된다.*/
			...
			)
	{
		...
		//사진들 업로드
		//사진 업로드를 안했을 경우 리스트의 첫 데이타 파밀명이 빈 문자열이 된다.
		// 즉! 업로드를했을 경우에만 db에 저장을 한다.
		...
		//새글인 경우는 1페이지로, 답글인 경우 보던 페이지로 이동
